              ...
              <form method="POST" action="">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" maxlength="14" name="no_mesin">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">No. Rangka</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" maxlength="18" name="no_rangka">
                  </div>
                  <div class="form-group">
